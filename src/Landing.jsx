        ...
        <>
            ...
            <div id="land-pro" className="product">
                    <div className="product-left-card">
                        <h2 className="colorings">Challenges, Community & Leaderboard</h2><br></br>
                    ...
                    <div className="product-right-card">
                        <h2 className="colorings" >Mentors & Skill Building</h2><br></br>
            ...
            <div id="land-comp" className="land-compiler">
               <div className="comp">
                <h2 className="colorings" >Compiler</h2><br></br>
